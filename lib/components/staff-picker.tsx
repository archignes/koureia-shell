        ...
        {allowNoPreference ? (
          <label
            className={cn(
              ...
              selectedStaffId === "any" && "border-b-[var(--shell-accent)] bg-[rgba(199,164,106,0.1)] before:border-[var(--shell-accent)] before:bg-[var(--shell-accent)] before:shadow-[inset_0_0_0_3px_var(--shell-bg-elevated)]"
            )}
